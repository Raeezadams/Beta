...
const Outsourcing = (props) => {
  return (
    <div className="outsourcing-container">
      <Helmet>
        <title>Outsourcing - Beta</title>
        <meta property="og:title" content="Outsourcing - Beta" />
      </Helmet>
      <header data-thq="thq-navbar" className="outsourcing-navbar-interactive">
        ...
        <div data-thq="thq-burger-menu" className="outsourcing-burger-menu">
        ...
        <div data-thq="thq-mobile-menu" className="outsourcing-mobile-menu">
          <div className="outsourcing-sidebar">
            <nav className="outsourcing-nav">
              ...
              />
              <span className="outsourcing-text01">Software Development</span>
              <span className="outsourcing-text02">Outsourcing</span>
              <span className="outsourcing-text03">UI &amp; UX Design</span>
              <span className="outsourcing-text04">Consulting</span>
              <span>Partnership</span>
            </nav>
            <span className="outsourcing-text06">Partnership</span>
          </div>
        </div>
      </header>
