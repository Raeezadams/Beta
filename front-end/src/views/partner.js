...
const Partner = (props) => {
  return (
    <div className="partner-container">
      <Helmet>
        <title>Partner - Beta</title>
        <meta property="og:title" content="Partner - Beta" />
      </Helmet>
      <header data-thq="thq-navbar" className="partner-navbar-interactive">
        <img alt="logo" src="/icon-1500h.png" className="partner-image" />
        <div data-thq="thq-navbar-nav" className="partner-desktop-menu">
          <nav className="partner-links">
            <Link to="/software-development" className="partner-text">
              Software Development
            </Link>
            <Link to="/outsourcing" className="partner-navlink">
              Outsourcing
            </Link>
            <Link to="/ui-ux-design" className="partner-navlink1">
              UI &amp; UX Design
            </Link>
            <Link to="/consulting" className="partner-navlink2">
              Consulting
            </Link>
          </nav>
          <div className="partner-buttons">
            <Link to="/" className="partner-navlink3">
              <svg viewBox="0 0 1024 1024" className="partner-icon">
                <path d="M426 854h-212v-342h-128l426-384 426 384h-128v342h-212v-256h-172v256z"></path>
              </svg>
            </Link>
          </div>
        </div>
        <div data-thq="thq-burger-menu" className="partner-burger-menu">
          <svg viewBox="0 0 1024 1024" className="partner-icon02">
            <path d="M128 554.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 298.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667zM128 810.667h768c23.552 0 42.667-19.115 42.667-42.667s-19.115-42.667-42.667-42.667h-768c-23.552 0-42.667 19.115-42.667 42.667s19.115 42.667 42.667 42.667z"></path>
          </svg>
        </div>
        <div data-thq="thq-mobile-menu" className="partner-mobile-menu">
          <div className="partner-sidebar">
            <nav className="partner-nav">
              ...
              />
              <span className="partner-text01">Software Development</span>
              <span className="partner-text02">Outsourcing</span>
              <span className="partner-text03">UI &amp; UX Design</span>
              <span className="partner-text04">Consulting</span>
              <span>Partnership</span>
            </nav>
            <span className="partner-text06">Partnership</span>
          </div>
        </div>
      </header>
